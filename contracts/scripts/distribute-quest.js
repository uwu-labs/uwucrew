...
const airdropInfo = require("../snapshots/cakeclaim.json");
...
async function main() {
  ...
  const airdrop = await ethers.getContractAt("UwuQuestStampsUpgradeable", "0xcec3597d2fddd38339d26d5097691ad29330456d") // uwu
