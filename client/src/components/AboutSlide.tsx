...
const AboutSlide = () => {
	return (
		<Slide
			...
			header="About"
			subHeaders={[
				'uwucrew, released on September 5th 2021, is an art collection of 9670 anime-inspired avatars created by uwu Labs. We love to empower artists and engage our community!',
