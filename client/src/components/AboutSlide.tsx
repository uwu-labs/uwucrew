...
const AboutSlide = () => {
	return (
		<Slide
			...
			header="About"
			subHeaders={[
				'We believe that through making collecting NFT art a fulfilling hobby, creativity can be empowered everywhere in the world with no boundaries! By building a close relationship with art with our community, we can help people find creators they enjoy supporting!',
