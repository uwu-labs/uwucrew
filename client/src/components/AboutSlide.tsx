	...
	return (
		<Slide
			...
			subHeaders={[
				...
				'uwucrew is set to launch September 5th @ 5:30 PM EST at the cost of 0.06 ETH each, featuring a re-imagined minting process which aims to prevent gas wars and make minting a painless and accessible experience. More details on this later!'
			]}
		/>
	);
};
