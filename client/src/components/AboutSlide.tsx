...
const AboutSlide = () => {
	return (
		<Slide
			...
			header="About"
			subHeaders={[
				'uwucrew, released on September 5th 2021, is an NFT art collection of 9670 anime style inspired avatars created by uwu Labs. We want to keep it uwu and foster a culture around empowering artists, involving our community as much as possible!',
