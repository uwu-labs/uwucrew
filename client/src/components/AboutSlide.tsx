...
const AboutSlide = () => {
	return (
		<Slide
			...
			header="About"
			subHeaders={[
				'uwucrew is a generative collection of 9670 femme-focused avatars inspired by anime and pop culture, aiming to be both inclusive and expressive. Every uwucrew NFT is completely unique and features up to 8 traits with 120+ assets.',
