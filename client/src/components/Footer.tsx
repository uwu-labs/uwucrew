...
import opensea from '../assets/svgs/socials/opensea.svg';
...
const Footer: React.FC = () => {
	return (
		<StyledFooter>
			<Line />
			<Socials>
				<a href="https://opensea.io/collection/uwucrew" target="_blank" rel="noreferrer" style={{ transform: 'translateY(3px)' }}>
					<Social src={opensea} />
				</a>
				<a
